...
The folder is a git repository. Commit the changes with message "Updated on {yyyy-mm-dd}" where {yyyy-mm-dd} is the current date, and push the current branch to origin.
